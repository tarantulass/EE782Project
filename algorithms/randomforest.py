...
def random_forest_regressor(data: Path, n_estimators=20):
    logger = logsetup()
    ...
    results_dir = Path(config.RANDOMFOREST_DIR)
    results_dir.mkdir(exist_ok=True)

    metrics_path = results_dir / "randomforest_metrics.txt"
    ...
    fi_path = results_dir / "randomforest_feature_importance.txt"
...
if __name__ == "__main__":
    ...
    random_forest_regressor(data_path)
